<!-- Footer -->
             <div class="footer text-center bg-white shadow-sm py-3 mt-5 no-print">
                <p class="m-0">Copyright © 2024. All Rights Reserved. <a href="<?= $base_url ?>" class="text-primary" target="_blank" >Technova Training Institute</a></p>
            </div>
    </div>
     <!-- Scripts -->
