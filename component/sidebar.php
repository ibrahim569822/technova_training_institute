        ...
        <div class="sidebar">
               ...
               <div class="sidebar-body  custom-scrollbar">
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="<?= $base_url ?>courses/courselist.php" class="sidebar-link"><i class="fa-brands fa-discourse"></i><p>Courses</p></a></li>
                        <li><a href="<?= $base_url ?>trainees/list.php" class=" sidebar-link"><i class="fa-solid fa-user"></i><p>Trainees</p></a></li>
                        <li><a href="<?= $base_url ?>teachers/teacher.php" class=" sidebar-link"><i class="fa-solid fa-chalkboard-user"></i><p>Teachers</p></a></li>
                        <li><a href="<?= $base_url ?>library/library.php" class=" sidebar-link"><i class="fa-solid fa-book"></i><p>Library</p></a></li>
                        <li><a href="<?= $base_url ?>departments/department.php" class=" sidebar-link"><i class="fa-solid fa-building"></i><p>Department</p></a></li>
                        <li><a href="<?= $base_url ?>staff/staff.php" class="sidebar-link"><i class="fa-solid fa-users"></i><p>Staff</p></a></li>
                        <li><a href="<?= $base_url ?>fees/fees.php" class="sidebar-link"><i class="fa-solid fa-dollar-sign"></i><p>Fees</p></a></li>
                        <li><a href="#" class=" sidebar-link submenu-parent"><i class="fa-solid fa-list"></i><p>Pages <i class="fa-solid fa-chevron-right right-icon"></i></p></a>
                            <ul class="sidebar-submenu">
                                <li><a href="<?= $base_url ?>pages/login.php" class="submenu-link"><i class="fa-solid fa-circle me-4 font-size-12"></i><p class="m-0">Login</p></a></li>
                                <li><a href="<?= $base_url ?>pages/signup.php" class="submenu-link"><i class="fa-solid fa-circle me-4 font-size-12"></i><p class="m-0">Register</p></a></li>
                                <li><a href="<?= $base_url ?>pages/forgot-password.php" class="submenu-link"><i class="fa-solid fa-circle me-4 font-size-12"></i><p class="m-0">Forgot password</p></a></li>
                                <li><a href="<?= $base_url ?>pages/404.php" class="submenu-link"><i class="fa-solid fa-circle me-4 font-size-12"></i><p class="m-0">404 page</p></a></li>
                                <li><a href="<?= $base_url ?>pages/500.php" class="submenu-link"><i class="fa-solid fa-circle me-4 font-size-12"></i><p class="m-0">500 page</p></a></li>
                            </ul>
                        </li>
