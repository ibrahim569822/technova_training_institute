        ...
        <div class="sidebar">
               ...
               <div class="sidebar-body  custom-scrollbar">
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="<?php echo $base_url; ?>course.php" class="sidebar-link"><i class="fa-brands fa-discourse"></i><p>Courses</p></a></li>
                        <li><a href="<?php echo $base_url; ?>students.php" class=" sidebar-link"><i class="fa-solid fa-user"></i><p>Students</p></a></li>
                        <li><a href="<?php echo $base_url; ?>teacher.php" class=" sidebar-link"><i class="fa-solid fa-chalkboard-user"></i><p>Teachers</p></a></li>
