...
<?php
  $id = $_GET['id'];
  $question = $crud->common_select("questions", "*", ['id' => $id]);
  if (!$question['status'] || empty($question['data'])) {
          ...
          <form action="<?= $base_url; ?>questions/update.php" method="POST" class="p-4">
            <div class="row">
              <div class="col-md-12 mb-12">
                ...
                <input type="text" class="form-control" id="question_name" name="question_name" value="<?= $question->question_name ?>" required>
              </div>
            </div>
            <div class="row">
