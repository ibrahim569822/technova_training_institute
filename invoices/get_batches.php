...
$enrollment = $crud->common_query("SELECT enrollments.`batch_id`,batches.batch_name, batches.Price, batches.Discount, batches.Discount_type,courses.course_name FROM `enrollments` 
