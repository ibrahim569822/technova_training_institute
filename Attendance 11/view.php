            ...
            <div class="card-body p-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="fw-bold"><?= $batch->start_time ?> - <?= $batch->end_time ?> (Room:
                            <?= $batch->room ?>)
                        </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="fw-bold">Price: <?= number_format($batch->Price, 2) ?> | Discount:
                            <?= $batch->Discount ?> (<?= $batch->Discount_type == 1 ? 'Fixed' : '%' ?>)
                        </p>
                    </div>
                    <div class="col-md-6 mb-3">
